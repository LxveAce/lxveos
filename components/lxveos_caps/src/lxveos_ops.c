...
static const lxveos_op_t OPS[] = {
    ...
    {"flock_detect",   "Flock Safety camera heuristic", LXVEOS_OPCAT_DEFENSE, LXVEOS_CAP_BLE, "Marauder", true},
    {"surveil_scan",   "Counter-surveillance BLE sweep", LXVEOS_OPCAT_DEFENSE, LXVEOS_CAP_BLE, "custom", true},
