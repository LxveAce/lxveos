...
| `subghz begin <sclk> <miso> <mosi> <cs> \| rssi <mhz> \| capture <gdo0> <mhz> [s] \| decode \| replay <gdo0> \| end` | CC1101 sub-GHz: RSSI + OOK capture (receive) plus arm-gated `replay` (offensive OOK re-emit). Add-on module |
